...
{
    public class TensOrBetterPayTable : IPayTable
    {
        public IList<WinCombination> WinCombinations => new List<WinCombination>
        {
            new WinCombination("Royal Flush",             new RoyalFlush(),          250, 500, 750, 1000, 4000),
            ...
            new WinCombination("Pair of Tens or Better",  new PairOfTensOrBetter(),    1,   2,   3,    4,    5),
        };

        public string Description => "Tens or Better";
